...
try {
    ...
    $mail->Body    = 'Dear, User your recovery key is:<br><b>' . $rekey . '</b><br>Please do not share this recovery key with others.';
...
<body>
    <div class="container-fluid col-md-5 bg-success">
        Forgot your password?<br>Provide your email to send recover your account.
